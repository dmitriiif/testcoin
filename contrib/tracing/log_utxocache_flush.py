...
"""Example logging Testcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/testcoind
...
def main(testcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[testcoind_with_usdts])
