...
# Extract options
function __fish_testcoin_tx_get_options
...
# Extract commands
function __fish_testcoin_tx_get_commands
...
complete \
    --command testcoin-tx \
    --condition "not __fish_testcoin_seen_cmd (__fish_testcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_testcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command testcoin-tx \
    --arguments "(__fish_testcoin_tx_get_commands)" \
    --no-files
