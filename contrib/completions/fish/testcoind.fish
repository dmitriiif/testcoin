...
complete --command testcoind --no-files

# Extract options
function __fish_testcoind_get_options
...
complete \
    --command testcoind \
    --arguments "(__fish_testcoind_get_options --nofiles)"
