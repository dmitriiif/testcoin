...
complete --command testcoin-qt --no-files

# Extract options
function __fish_testcoinqt_get_options
...
complete \
    --command testcoin-qt \
    --arguments "(__fish_testcoinqt_get_options --nofiles)"
