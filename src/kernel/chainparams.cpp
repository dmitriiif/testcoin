...
// Copyright (c) 2009-2021 The Testcoin Core developers
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.testcoin.dashjr-list-of-p2p-nodes.us."); // Luke Dashjr
        ...
        vSeeds.emplace_back("seed.testcoin.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.testcoin.wiz.biz."); // Jason Maurice
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x0D, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x0D, 0x88, 0xAD, 0xE4};
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.testcoin.sprovoost.nl.");

            // Hardcoded nodes can be removed once there are more DNS seeds
            vSeeds.emplace_back("178.128.221.177");
            vSeeds.emplace_back("v7ajjeirttkbnt32wpy3c6w3emwnfr3fkla7hpxcfokr3ysd3kqtzmqd.onion:39801");
