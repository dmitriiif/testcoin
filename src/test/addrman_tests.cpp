...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK(addr_ret2.ToStringAddrPort() == "250.1.1.1:9801" || addr_ret2.ToStringAddrPort() == "250.1.1.1:8334");
...
BOOST_AUTO_TEST_CASE(addrman_update_address)
{
    ...
    CAddress addr_v2{CAddress(ResolveService("250.1.1.1", 9801), NODE_P2P_V2)};
