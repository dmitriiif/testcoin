// Copyright (c) 2023 The Testcoin Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // testcoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/testcoin/testcoin/issues/16220 about ways to
        ...
        // Show an error or warning if there is a testcoin.conf file in the
