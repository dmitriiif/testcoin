...
{
    // Test regression https://github.com/testcoin/testcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/testcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/testcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Testcoin/Testcoin-Qt.conf and all else left as default,
    // testcoin-qt should set both -listen and -listenonion to false and start successfully.
