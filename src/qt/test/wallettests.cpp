// Copyright (c) 2015-2022 The Testcoin Core developers
...
void CompareBalance(WalletModel& walletModel, CAmount expected_balance, QLabel* balance_label_to_check)
{
    ...
    QString balanceComparison = TestcoinUnits::formatWithUnit(unit, expected_balance, false, TestcoinUnits::SeparatorStyle::ALWAYS);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_testcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_testcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_testcoin-qt  # macOS
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_testcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
