...
//! Entry point for TestcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TestcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TestcoinGUI tests.
void AppTests::guiTests(TestcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TestcoinGUI::consoleShown, this, &AppTests::consoleTests);
