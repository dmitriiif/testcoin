      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->testcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->testcoinAtStartup);
    ...
    ui->testcoinAtStartup->setToolTip(ui->testcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->testcoinAtStartup->setText(ui->testcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openTestcoinConfButton->setToolTip(ui->openTestcoinConfButton->toolTip().arg(PACKAGE_NAME));
