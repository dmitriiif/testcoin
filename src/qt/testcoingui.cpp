...
TestcoinGUI::TestcoinGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &TestcoinGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &TestcoinGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &TestcoinGUI::showModalOverlay);
...
void TestcoinGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &TestcoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &TestcoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &TestcoinGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Testcoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Testcoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a testcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Testcoin command-line options").arg(PACKAGE_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &TestcoinGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &TestcoinGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &TestcoinGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &TestcoinGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &TestcoinGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &TestcoinGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const std::pair<const std::string, bool>& i : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &TestcoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &TestcoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &TestcoinGUI::createWallet);
        connect(m_close_all_wallets_action, &QAction::triggered, [this] {
            m_wallet_controller->closeAllWallets(this);
        });
        connect(m_migrate_wallet_action, &QAction::triggered, [this] {
            auto activity = new MigrateWalletActivity(m_wallet_controller, this);
            connect(activity, &MigrateWalletActivity::migrated, this, &TestcoinGUI::setCurrentWallet);
            activity->migrate(walletFrame->currentWalletModel());
        });
        connect(m_mask_values_action, &QAction::toggled, this, &TestcoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &TestcoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &TestcoinGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &TestcoinGUI::showDebugWindow);
}
...
void TestcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &TestcoinGUI::setCurrentWalletBySelectorIndex);
...
void TestcoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &TestcoinGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &TestcoinGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &TestcoinGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &TestcoinGUI::showProgress);
...
#ifdef ENABLE_WALLET
void TestcoinGUI::enableHistoryAction(bool privacy)
{
...
void TestcoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &TestcoinGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &TestcoinGUI::removeWallet);
...
WalletController* TestcoinGUI::getWalletController()
{
    return m_wallet_controller;
}

void TestcoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &TestcoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &TestcoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &TestcoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &TestcoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &TestcoinGUI::incomingTransaction);
    connect(this, &TestcoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void TestcoinGUI::removeWallet(WalletModel* walletModel)
{
...
void TestcoinGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void TestcoinGUI::setCurrentWalletBySelectorIndex(int index)
{
...
void TestcoinGUI::createTrayIconMenu()
{
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &TestcoinGUI::toggleHidden);
...
void TestcoinGUI::gotoLoadPSBT(bool from_clipboard)
{
...
void TestcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Testcoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void TestcoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void TestcoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void TestcoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &TestcoinGUI::quitRequested);
...
void TestcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void TestcoinGUI::createWallet()
{
    ...
    connect(activity, &CreateWalletActivity::created, this, &TestcoinGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void TestcoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void TestcoinGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &TestcoinGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &TestcoinGUI::show);
                e->ignore();
            }
        }
    }
...
#ifdef ENABLE_WALLET
void TestcoinGUI::incomingTransaction(const QString& date, TestcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
...
void TestcoinGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void TestcoinGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void TestcoinGUI::updateProxyIcon()
{
    std::string ip_port;
...
void TestcoinGUI::updateWindowTitle()
{
...
static bool ThreadSafeMessageBox(TestcoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = TestcoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
bool TestcoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<TestcoinUnit> units = TestcoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const TestcoinUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, TestcoinUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const TestcoinUnit u : TestcoinUnits::availableUnits()) {
        menu->addAction(TestcoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(TestcoinUnit newUnits)
{
