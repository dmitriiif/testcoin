...
public:
    ...
    TestcoinUnit getDisplayUnit() const { return m_display_testcoin_unit; }
...
private:
    ...
    QString language;
    TestcoinUnit m_display_testcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(TestcoinUnit unit);
