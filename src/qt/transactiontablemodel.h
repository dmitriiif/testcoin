...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TestcoinUnits::SeparatorStyle separators=TestcoinUnits::SeparatorStyle::STANDARD) const;
