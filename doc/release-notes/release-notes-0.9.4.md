Testcoin Core version 0.9.4 is now available from:
...
this update is incompatible with the Testcoin system and could lead to consensus
forks.

Testcoin Core released binaries from https://testcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~testcoin/+archive/ubuntu/testcoin
- A third-party or self-compiled Testcoin Core

upgrade to Testcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
