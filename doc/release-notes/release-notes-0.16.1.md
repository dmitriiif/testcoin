Testcoin Core version 0.16.1 is now available from:

  <https://testcoincore.org/bin/testcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting testcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure testcoind processes are cleaned up when tests end (sdaftuar)
