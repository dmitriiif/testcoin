Testcoin Core version 0.11.2 is now available from:

  <https://testcoin.org/bin/testcoin-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include testcoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split testcoin-tx into its own package
