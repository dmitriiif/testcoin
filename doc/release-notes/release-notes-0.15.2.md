Testcoin Core version *0.15.2* is now available from:

  <https://testcoincore.org/bin/testcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in testcoin-tx (TheBlueMatt)
