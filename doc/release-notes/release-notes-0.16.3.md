Testcoin Core version 0.16.3 is now available from:

  <https://testcoincore.org/bin/testcoin-core-0.16.3/>
...
been discovered in Testcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` testcoinconsensus: invalid flags error should be set to `testcoinconsensus_err` (afk11)
