...
Testcoin Core version 0.19.1 is now available from:

  <https://testcoincore.org/bin/testcoin-core-0.19.1/>
...
From Testcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Testcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Testcoin Core does not yet change appearance when
...
- #17488 fix "testcoind already running" warnings on macOS (fanquake)
