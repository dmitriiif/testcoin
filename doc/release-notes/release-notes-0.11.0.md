Testcoin Core version 0.11.0 is now available from:
...
Block pruning allows Testcoin Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Testcoin Core will 
...
- #5334 `cf87536` libtestcoinconsensus: Add pkg-config support
...
- #5729 `9c4a5a5` Allow unit changes for read-only TestcoinAmountField
...
- #5849 `41259ca` contrib/init/testcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Testcoin-Qt.app to Testcoin-Core.app
