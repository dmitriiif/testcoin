...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/testcoin/testcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our testcoind node")
