#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Testcoin Core developers
...
from test_framework.test_framework import TestcoinTestFramework, initialize_datadir


class BlocksdirTest(TestcoinTestFramework):
