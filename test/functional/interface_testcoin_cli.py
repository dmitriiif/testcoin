...
class TestTestcoinCli(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test -getinfo and testcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and testcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test testcoin-cli -generate with -rpcwallet in multiwallet mode.
