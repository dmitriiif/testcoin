#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Testcoin Core developers
...
class TxDownloadTest(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new testcoind instances, as setting mocktimes has long-term effects on when
