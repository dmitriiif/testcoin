...
Verify that a testcoind node can use an external signer command.
...
class RPCSignerTest(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart testcoind with -signer=<cmd>',
