...
class TestShell:
    """Wrapper Class for TestcoinTestFramework.

    The TestShell class extends the TestcoinTestFramework
    ...
    class __TestShell(TestcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TestcoinTestFramework child class.
            self.num_nodes = 1
