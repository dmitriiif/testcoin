...
"""
Test starting testcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(TestcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that testcoind has bound on "::1" (for RPC) and "::" (for P2P).
