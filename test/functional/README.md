...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The CI linter job also checks this, but [possibly not in all cases](https://github.com/testcoin/testcoin/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the TestcoinTestFramework, place overrides for the
...
- Use `platform.system()` for detecting the running operating system and `os.name` to
  ...
  methods in the `TestcoinTestFramework` class, which can be used to skip a whole test
...
with the testcoind(s) being tested in a callback-based event loop; the other
...
The [`TestShell`](test-shell.md) class exposes the TestcoinTestFramework
...
Test objects for interacting with a testcoind node over the p2p interface.
