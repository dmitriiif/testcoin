...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/testcoin/testcoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(TestcoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/testcoin/testcoin/issues/27380
