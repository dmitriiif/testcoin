#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Testcoin Core developers
...
class I2PPorts(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        with node.assert_debug_log(expected_msgs=[f"Error connecting to {addr}, connection refused due to arbitrary port 9801"]):
