...
interfaces.
- [util](/test/util) which tests the utilities (testcoin-util, testcoin-tx, ...).
...
Before tests can be run locally, Testcoin Core must be built.  See the [building instructions](/doc#building) for help.
